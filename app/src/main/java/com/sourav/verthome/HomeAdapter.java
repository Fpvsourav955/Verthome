...
public class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.MyViewHolder> {
    ...
    public HomeAdapter(Activity activity, Context context, ArrayList<String> id, ArrayList<String> title, ArrayList<String> address, ArrayList<String> hostid) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.mainLayout.setOnClickListener(v -> {
            ...
            intent.putExtra("host_id",String.valueOf(host_id.get(position)));
